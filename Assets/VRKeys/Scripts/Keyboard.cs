...
namespace VRKeys
{
    ...
    public class Keyboard : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            leftHand.transform.localPosition = InputTracking.GetLocalPosition(XRNode.LeftHand) + new Vector3(0, 1.5f, 0);
            leftHand.transform.localRotation = InputTracking.GetLocalRotation(XRNode.LeftHand);

            rightHand.transform.localPosition = InputTracking.GetLocalPosition(XRNode.RightHand) + new Vector3(0, 1.5f, 0);
